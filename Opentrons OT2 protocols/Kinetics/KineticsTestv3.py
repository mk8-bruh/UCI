...
def run(protocol: protocol_api.ProtocolContext):
    ...
    template=KineticsTemplate(protocol,pipette,sources=sources,washers=[-1,2],deposits=[(1,5,0),(-1,5,0),(-2,5,0),(2,5,0),(3,5,0)],volumes={'master':25,'starter':5,'killer':5,'washer':50},mixing={'starter':Mixing(2,10,blowOut=False,offset=1),'deposit':Mixing(1,5,blowOut=False,offset=1),'washer':Mixing(2,12,blowOut=False,offset=1)})
